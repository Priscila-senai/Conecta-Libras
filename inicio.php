...
.user-section .login-btn {
  ...
  align-items: center;
  gap: 8px;
  background: linear-gradient(135deg, #FFBE1D, #FFC947);
  color: #04334C;
...
.user-section .login-btn:hover .icon {
...
<div class="user-section">
  <a href="login.html" class="login-btn">
    <span class="icon">
      <!-- Ícone de portinha moderno -->
      <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 16 16">
        <path d="M6 1a1 1 0 0 0-1 1v2H4a2 2 0 0 0-2 2v7a1 1 0 0 0 1 1h8a1 1 0 0 0 1-1V6a2 2 0 0 0-2-2h-1V2a1 1 0 0 0-1-1H6zM5 2h2v2H5V2zm1 8a1 1 0 1 1 0-2 1 1 0 0 1 0 2z"/>
      </svg>
    </span>
    <span class="text">Login / Cadastro</span>
  </a>
</div>
